...
fun <T : CommandChain> T.replaceText(startPosition: Int?, endPosition: Int?, newText: String = ""): T = apply {
  addCommand("${CMD_PREFIX}replaceText start=${startPosition ?: "/"} end=${endPosition ?: "/"} text=${newText}")
}