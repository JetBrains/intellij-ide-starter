...
data class AlternativeIndexingMetrics(
...
fun extractAlternativeIndexingMetrics(startResult: IDEStartResult): AlternativeIndexingMetrics {
  val indexDiagnosticDirectory = startResult.context.paths.logsDir / "alternative-indexing-diagnostic"
  ...
  return AlternativeIndexingMetrics(startResult, jsonIndexDiagnostics)
}
